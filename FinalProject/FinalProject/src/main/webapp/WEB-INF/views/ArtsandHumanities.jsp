...
<h3 align = "center"  style="color:red;"> You can select maximum 3 subjects from any of the courses</h3> 
        ...
        <form action = "addBusinessCourses.htm" method = "post">
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Belief Systems" name="inlineCheckbox1"> Belief Systems
        </label><br/>
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Strategic Leadership and Management" name="inlineCheckbox2"> Strategic Leadership and Management
            </label><br/>
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Leading People and Teams" name="inlineCheckbox3"> Leading People and Teams
            </label> <br/>
          <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Nazi Germany" name="inlineCheckbox4"> Nazi Germany
             </label> <br/>
        <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Causes and Consequences" name="inlineCheckbox5"> Causes and Consequences
               </label> <br/>
        <input type = "submit" name= "addCourse" id="btnSubmit">
        <input type = "hidden" name="courseName" value="Arts and Humanities">
        </form>
                </div>
</body>
</html>
