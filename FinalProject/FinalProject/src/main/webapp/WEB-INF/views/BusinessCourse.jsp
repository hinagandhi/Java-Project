...
<h3 align = "center"  style="color:red;"> You can select maximum 3 subjects from any of the courses</h3> 
        ...
        <form action = "addBusinessCourses.htm" method = "post">
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Principles of Management" name="inlineCheckbox1"> Principles of Management
        </label><br/>
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Organizational Behavior" name="inlineCheckbox2"> Organizational Behavior
            </label><br/>
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Information Systems" name="inlineCheckbox3"> Information Systems
            </label> <br/>
          <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Business Law" name="inlineCheckbox4"> Business Law
             </label> <br/>
        <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Principles Of Marketing" name="inlineCheckbox5"> PrinciplesOfMarketing
               </label> <br/>
        <input type = "submit" name= "addCourse" id="btnSubmit">
        <input type = "hidden" name="courseName" value="Business">
        </form>
                </div>
</body>
</html>
