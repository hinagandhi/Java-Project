...
<h3 align = "center"  style="color:red;"> You can select maximum 3 subjects from any of the courses</h3> 
        ...
        <form action = "addBusinessCourses.htm" method = "post">
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Neural Networks For Machine Learning" name="inlineCheckbox1"> Neural Networks For Machine Learning
        </label><br/>
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Data Analysis and Interpretation" name="inlineCheckbox2"> Data Analysis and Interpretation
            </label><br/>
         <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Communicating Data Science Results" name="inlineCheckbox3"> Communicating Data Science Results
            </label> <br/>
          <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Business Analytics" name="inlineCheckbox4"> Business Analytics
             </label> <br/>
        <label class="checkbox">
            <input type="checkbox" class = "lessons" value="Methods and Statistics" name="inlineCheckbox5"> Methods and Statistics
               </label> <br/>
        <input type = "submit" name= "addCourse" id="btnSubmit">
        <input type = "hidden" name="courseName" value="Data Science">
        </form>
                </div>
</body>
</html>
