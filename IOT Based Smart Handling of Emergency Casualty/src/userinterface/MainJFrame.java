...
//import Business.Old.DB4OUtil.DB4OUtil;
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
            ...
            for (Network network : system.getNetworkList()) {
                ...
                for (Community community : network.getCommunityList().getCommunityList()) {
                    for (Area area : community.getAreaList().getAreaList()) {
                        ...
                        // System.out.println(userAccount.getArea());
                    ...
                    if (inarea != null || userAccount!= null ) {
                           break;
                      }
                }
                if ( (inEnterprise!= null && userAccount!=null) || (inarea!= null && userAccount!=null)) {
                         break;
                       }
            } 
        ...
        if (userAccount == null) {
            ...
            CardLayout layout = (CardLayout) container.getLayout();
               container.add("workArea", userAccount.getRole().createWorkArea(container, userAccount, inOrganization, inarea, inEnterprise, system));
